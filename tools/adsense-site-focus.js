...
function createGuidePage({ title, description, slug, category, updated, intro, sections, related }) {
  const canonical = `https://xn--989av19a47d.com/guides/${slug}/`;
  const ld = {
...
<meta property="og:image" content="https://xn--989av19a47d.com/og-image.svg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="${title}">
<meta name="twitter:description" content="${description}">
<meta name="twitter:image" content="https://xn--989av19a47d.com/og-image.svg">
  ...
  const body = urls
    .map(
      ([loc, changefreq, priority]) =>
        `  <url><loc>https://xn--989av19a47d.com${loc}</loc><changefreq>${changefreq}</changefreq><priority>${priority}</priority></url>`
    )
    .join('\n');
...
<link rel="canonical" href="https://xn--989av19a47d.com/guides/">
...
<meta property="og:url" content="https://xn--989av19a47d.com/guides/">
<meta property="og:image" content="https://xn--989av19a47d.com/og-image.svg">
<meta name="twitter:card" content="summary_large_image">
